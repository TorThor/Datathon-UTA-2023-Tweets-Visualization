In your IDE, simply run the code and enter a word you wish to search for in the database. Ensure the Excel file "TwitterHealthData.xlsx" is in the same root folder as the code. 
